...
var jqxhr = $.getJSON("static/journeyplanner/routes_stops.json", null, function (data) {
stations = data.bus;
...
// this function shows the list of routes operating at the stop the user choose
function route_list() {
//getting the value of the selected route
var sel = $("#myInput").val();

//jquery to open the json file 
$.getJSON("static/journeyplanner/routes_stops.json", null, function (data) {
